...
from .models import User,Achievement,Exams,Events,College,Requirements,Company,Department,Faculties,Project,Student,Subject,Timetable,student_data,Marks,Skills,Skill_list
